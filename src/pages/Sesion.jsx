  ...
  return (
    <div>
      <div className="container1">
        <div className="body1 d-md-flex align-items-center justify-content-between">
          <div className="box-1 mt-md-0 mt-5">
            <img src="https://images.pexels.com/photos/2033997/pexels-photo-2033997.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" className alt />
          </div>
              ...
              <div className="d-flex flex-column ">
                ...
                <div className="d-flex align-items-center">
                  <a href="#" className="box me-2 selectio">
                    <span className="fab fa-facebook-f mb-2" />
                  ...
                  <a href="#" className="box">
                    <span className="far fa-envelope mb-2" />
                    <p className="mb-0">Email</p>
                  </a>
                </div>
                <div className="mt-3">
                  <p className="mb-0 text-muted">Already have an account?</p>
                  <div className="btn btn-primary">Log in<span className="fas fa-chevron-right ms-1" /></div>
                </div>
              </div>
            </div>
